...
public class Hole extends Tile{
    ...
    public Hole(int x, int y, String color, double score_increase_from_hole_capture_modifier, double score_decrease_from_wrong_hole_modifier, int score_decrease_from_wrong_hole, int score_increase_from_hole_capture, Tile top_right, Tile bot_left, Tile bot_right ){
        super(x, y);
