...
public class Config {
  ...
  public Config(JSONObject config) {
    ...
    for (int i = 0; i < loaded_levels.size(); i++) {
      ...
      double score_increase_from_hole_capture_modifier = levelObj
          .getDouble("score_increase_from_hole_capture_modifier");
      ...
      levels[i] = new Level(layout, time, spawn_interval, score_increase_from_hole_capture_modifier,
          score_decrease_from_wrong_hole_modifier, balls);
    }
